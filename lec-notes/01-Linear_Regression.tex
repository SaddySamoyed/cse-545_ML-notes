...
% using explicit options in \pic[0.6][width, height, ...]{}
...
\pic[0.6]{Linear_Regression.assets/lec1-notation.png}
...
\pic[0.6]{Linear_Regression.assets/lec1(expression).png}
...
\pic[0.6]{Linear_Regression.assets/lec1-basis.png}
...
\pic[0.6]{Linear_Regression.assets/lec1-loss.png}
...
\pic[0.6]{ Linear_Regression.assets/lec1-gradient.png}
...
\pic[0.6]{ Linear_Regression.assets/lec1-descent.png}
...
\pic[0.6]{ Linear_Regression.assets/lec2-diff.png}

我们发现: \(E(w)\) 就是一个 \(w\) 的 quadratic form, 一个 \(w\) 的
linear form 和一个 const 的组合. 从而可以求出:

\pic[0.6]{ Linear_Regression.assets/lec2-grad.png}

从而我们得到 closed form solution (if exists):

\pic[0.6]{ Linear_Regression.assets/lec2-closed.png}
